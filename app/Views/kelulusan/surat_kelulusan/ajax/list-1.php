        ...
        <tr>
            ...
            <td style="vertical-align: middle;">
                <div class="d-flex align-items-center">
                    <div class="rounded-circle <?=(($siswa['foto_diri'] == '') ? 'bg-light justify-content-center d-flex align-items-center' : '')?>" data-nis="<?=$siswa['nis']?>" style="overflow: hidden; height: 56px; width: 56px; cursor: pointer">
                    ...
                    <div class="font-weight-bold pl-2">
                        <h4 class="mb-0 mt-0" style="font-size: 16pt;">
                            <?=$siswa['nama_lengkap']?>
